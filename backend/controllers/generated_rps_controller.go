	...
	if tugasData, ok := result["tugas"].([]interface{}); ok {
		for i := 0; i < 3; i++ {
			if i < len(tugasData) {
				...
				// Jika tugas tidak ada, kosongkan placeholder
